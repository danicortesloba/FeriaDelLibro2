...
class ClassificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classification" do
    assert_difference('Classification.count') do
      post classifications_url, params: { classification: { book_id: @classification.book_id, genre_id: @classification.genre_id } }
    end
  ...
  test "should update classification" do
    patch classification_url(@classification), params: { classification: { book_id: @classification.book_id, genre_id: @classification.genre_id } }
